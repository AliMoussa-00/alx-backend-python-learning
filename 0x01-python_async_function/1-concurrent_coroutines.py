...
async def wait_n(n: int, max_delay: int) -> List[float]:
    '''
    Asynchronously spawns 'n' instances of 'wait_random' coroutine with the specified 'max_delay',
    ...
    Parameters:
        ...
        max_delay (int): The maximum delay value for each 'wait_random' coroutine.
